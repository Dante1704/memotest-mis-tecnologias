  ...
  return (
    <main className='min-h-screen flex flex-col xl:flex-row justify-evenly items-center gap-10'>
      <div className='flex items-center gap-2'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" id="X" className='w-9 h-9'><path fill="none" fillRule="evenodd" stroke="#d85b53" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 1 1 13M1 1l12 12" className="colorStroke000000 svgStroke"></path></svg>
      ...
      <div className='flex flex-col justify-center items-center gap-10'>
        ...
        <button onClick={handleReset} className="btn btn-outline btn-accent w-[300px]">Jugar de nuevo</button>
      </div>
      <Scores/>
    </main>
  )

...
function Home (): JSX.Element {
  return (
      ...
      <main className="min-h-screen flex flex-col items-center justify-center gap-16">
        ...
        <div className='rounded border-2 flex flex-col p-8 gap-10'>
          <span>Apagá por un ratito el chip laboral y juegá al memotest con las tecnologías con las que trabajo!</span>
          <p>Liderá la grilla de scores por menor cantidad de errores!</p>
        </div>
        <div className='flex gap-5'>
          <Link to={'/memotest'} className="btn btn-accent">A Jugar!</Link>
          <Link to={'/scores'} className="btn btn-outline btn-accent">Ver Scores</Link>
        </div>
      </main>
